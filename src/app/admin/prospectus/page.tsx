                ...
                <div className="flex items-center gap-3">
                  {upload.processed ? (
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 bg-red-500 hover:bg-red-400 text-blue-900 px-3 py-1.5 rounded-xl text-xs font-semibold transition-all disabled:opacity-60"
                    >
