...
export default function DocumentsPage() {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
      ...
      {/* Important notice */}
      <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-4 mb-6 space-y-2">
        <p className="text-sm font-bold text-yellow-800">⚠️ Before uploading please ensure:</p>
